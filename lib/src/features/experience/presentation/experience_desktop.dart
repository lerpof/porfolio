...
class ExperienceDesktop extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final experiences = ref.watch(experienceRepositoryProvider).getExperiences();
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(tr(ref, TranslationKeys.experienceSectionTitle), style: Theme.of(context).textTheme.titleLarge),
        ),
