        ...
        child: SelectionContainer.disabled(
          child: OutlinedButton(
            style: OutlinedButton.styleFrom(
              backgroundColor: _isHovered ? theme.colorScheme.tertiary.withValues(alpha: 0.1) : null,
              side: BorderSide(width: _isHovered ? 2 : 1, color: theme.colorScheme.tertiary),
              elevation: 16,
            ...
            child: Row(
              ...
              children: [
                ...
                gapW12,
                Text(tr(ref, TranslationKeys.resume), style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
              ],
            ),
          ),
        ),
    ...
    if (widget.resumes.length > 1) {
      ...
      if (resumeFirstUrl == null) {
        ...
        try {
          ...
          if (context.mounted) {
            ScaffoldMessengerHelper.showLaunchUrlError(context, url: resumeFirstUrl);
          }
        }
      }
    } else {
