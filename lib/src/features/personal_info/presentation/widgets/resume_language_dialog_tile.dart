      ...
      child: Row(
        ...
        children: [
          Padding(
            ...
            child: _buildResumeLanguageTileContent(context, ref, resume: resume),
          ),
        ],
      ),
    );
...
Widget _buildResumeLanguageTileContent(BuildContext context, WidgetRef ref, {required Resume resume}) {
  ...
  if (resumeLanguageCode == null) {
    return Text(tr(ref, TranslationKeys.unknownLanguageError), style: Theme.of(context).textTheme.titleMedium);
  }
  ...
  return Row(
    children: [
      ...
      gapW8,
      Text(language.name ?? tr(ref, TranslationKeys.unknownLanguageError), style: Theme.of(context).textTheme.titleMedium),
    ],
  );
}
